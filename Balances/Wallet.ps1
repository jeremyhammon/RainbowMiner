...
$Wallets_Data = @(
    ...
    [PSCustomObject]@{symbol = "BTC";  match = "^[13]|^bc1"; rpc = "https://api.blockcypher.com/v1/btc/main/addrs/{w}";                   address = "address";                          balance = "balance";                         received = "total_received";                   divisor = 1e8}
