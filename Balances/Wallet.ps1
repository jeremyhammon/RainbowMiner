...
$Wallets_Data = @(
    ...
    [PSCustomObject]@{symbol = "DASH";  match = "^Xn";  rpc = "https://api.blockcypher.com/v1/dash/main/addrs/{w}";                   address = "address";                          balance = "balance";                         received = "total_received";                   divisor = 1}
    [PSCustomObject]@{symbol = "DOGE";  match = "^D";   rpc = "https://api.blockcypher.com/v1/doge/main/addrs/{w}";                   address = "address";                          balance = "balance";                         received = "total_received";                   divisor = 1}
    )
